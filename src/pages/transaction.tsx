...
import TransactionItem, { TRANSACTION_TYPE } from "../components/TransactionComponent";
import { getTx as getBTCTx } from "../query/btc/memepool";
import { getTx as getCKBTx } from "../query/ckb/tools";
import { RootState } from "../store/store";
import { useSelector } from "react-redux";
import {  BTCTxInfo, ckb_TxInfo, groupedTransaction, GroupedTransactions, TransactionDetails } from "../types/BTC";
...
function processTransaction(transaction: BTCTxInfo): TransactionDetails {
  ...
  const _getCKBTx = async () => {
      ...
      try {
          ...
          console.log("=======groupedTx==",groupedTx)
  ...
  return (
    <main className="flex flex-col flex-1 h-full bg-gray-100 text-black">
      <div className="h-full w-full flex flex-col">
        <div className="sm:mt-20 flex text-black text-hd1mb border-b border-gray-300 w-full py-6 px-8 font-Montserrat font-bold">
          Transaction
        </div>
