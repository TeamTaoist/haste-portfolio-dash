        ...
        <div className={`pt-8
          ...
          <div className='flex flex-col mt-8'>
            <div className='flex items-center px-4 gap-4 py-4'>
              ...
              <p className={`font-SourceSanPro text-body1mb ${activeTab === 'dashboard' ? 'font-semibold': ''}`}>Dashboard</p>
            </div>
          </div>
          <div className='flex flex-col'>
            <div className='flex items-center px-4 gap-4 py-4'>
              <FileTextIcon color="#8C92BA" className='w-6 h-6'/>
              <p className={`font-SourceSanPro text-body1mb ${activeTab === 'transaction' ? 'font-semibold': ''}`}>Transaction</p>
            </div>
          </div>
          <div className='flex flex-col'>
            <div className='flex items-center px-4 gap-4 py-4'>
              <PaperPlaneIcon color="#8C92BA" className='w-6 h-6'/>
              <p className={`font-SourceSanPro text-body1mb ${activeTab === 'send' ? 'font-semibold': ''}`}>Send & Receive</p>
            </div>
          </div>  
        </div>
      ) : (
