...
import ReiImg from "../../../assets/img/reiwallet.png";
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          <div className='flex items-center gap-4 rounded py-2 px-2 bg-white relative cursor-pointer'
            ...
            <img className='rounded-full' src={OkxImg} width={40} height={40} alt={'btc-okx'}/>
          ...
          <div className='flex items-center gap-4 rounded py-2 px-2 bg-white cursor-pointer'
            ...
            <img className='rounded-full' src={UnisatImg} width={40} height={40} alt={'btc-unisat'}/>
            <p className='text-black font-Montserrat'>Unisat</p>
          </div>
          <div className='flex items-center gap-4 rounded py-2 px-2 bg-white cursor-pointer'
               onClick={connectJoyIDBTCWallet}>
            <img className='rounded-full' src={JoyidImg} width={40} height={40} alt={'btc-joyid'}/>
        ...
        <div className='flex items-center gap-4 rounded py-2 px-2 bg-white cursor-pointer'
          ...
          <img className='rounded-full border' src={ReiImg} width={40} height={40} alt={'ckb-joyid'}/>
          <p className='text-black font-Montserrat'>REI wallet</p>
        </div>
        <div className='flex items-center gap-4 rounded py-2 px-2 bg-white cursor-pointer'
             onClick={connectJoyIDCKBWallet}>
          <img className='rounded-full' src={JoyidImg} width={40} height={40} alt={'ckb-joyid'}/>
          <p className='text-black font-Montserrat'>JoyID</p>
        </div>
